...
if (Config.WORKTYPE == 'private') {
    ...
    Asena.addCommand({pattern: 'ownercmnd', fromMe: false, desc: 'set of commands for bot user or sudo'}, (async (message, match) => {    
